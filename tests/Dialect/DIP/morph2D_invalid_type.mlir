...
func.func @main() -> i32 {
  ...
  dip.erosion_2d <CONSTANT_PADDING> %input_i32, %identity_f32, %output_f32erosion, %kernelAnchorX, %kernelAnchorY, %iterations, %c_f32 : memref<3x3xi32>, memref<3x3xf32>, memref<3x3xf32>, index, index, index, f32
  // CHECK: 'dip.erosion_2d' op input, kernel, output and constant must have the same element type

  dip.erosion_2d <CONSTANT_PADDING> %input_f32, %identity_i32, %output_f32erosion, %kernelAnchorX, %kernelAnchorY, %iterations, %c_f32 : memref<3x3xf32>, memref<3x3xi32>, memref<3x3xf32>, index, index, index, f32
  // CHECK: 'dip.erosion_2d' op input, kernel, output and constant must have the same element type

  dip.erosion_2d <CONSTANT_PADDING> %input_f32, %identity_f32, %output_i32erosion, %kernelAnchorX, %kernelAnchorY, %iterations, %c_f32 : memref<3x3xf32>, memref<3x3xf32>, memref<3x3xi32>, index, index,index, f32
  // CHECK: 'dip.erosion_2d' op input, kernel, output and constant must have the same element type

  dip.erosion_2d <CONSTANT_PADDING> %input_f32, %identity_f32, %output_f32erosion, %kernelAnchorX, %kernelAnchorY, %iterations, %c_i32 : memref<3x3xf32>, memref<3x3xf32>, memref<3x3xf32>, index, index,index, i32
  // CHECK: 'dip.erosion_2d' op input, kernel, output and constant must have the same element type

  dip.erosion_2d <CONSTANT_PADDING> %input_f128, %identity_f128, %output_f128erosion, %kernelAnchorX, %kernelAnchorY, %iterations, %c_f128 : memref<3x3xf128>, memref<3x3xf128>, memref<3x3xf128>, index, index,index, f128
  // CHECK: 'dip.erosion_2d' op supports only f32, f64 and integer types. 'f128'is passed

  dip.dilation_2d <CONSTANT_PADDING> %input_i32, %identity_f32, %output_f32dilation, %kernelAnchorX, %kernelAnchorY, %iterations, %c_f32 : memref<3x3xi32>, memref<3x3xf32>, memref<3x3xf32>, index, index, index, f32
  // CHECK: 'dip.dilation_2d' op input, kernel, output and constant must have the same element type

  dip.dilation_2d <CONSTANT_PADDING> %input_f32, %identity_i32, %output_f32dilation, %kernelAnchorX, %kernelAnchorY, %iterations, %c_f32 : memref<3x3xf32>, memref<3x3xi32>, memref<3x3xf32>, index, index, index, f32
  // CHECK: 'dip.dilation_2d' op input, kernel, output and constant must have the same element type

  dip.dilation_2d <CONSTANT_PADDING> %input_f32, %identity_f32, %output_i32dilation, %kernelAnchorX, %kernelAnchorY, %iterations, %c_f32 : memref<3x3xf32>, memref<3x3xf32>, memref<3x3xi32>, index, index,index, f32
  // CHECK: 'dip.dilation_2d' op input, kernel, output and constant must have the same element type

  dip.dilation_2d <CONSTANT_PADDING> %input_f32, %identity_f32, %output_f32dilation, %kernelAnchorX, %kernelAnchorY, %iterations, %c_i32 : memref<3x3xf32>, memref<3x3xf32>, memref<3x3xf32>, index, index,index, i32
  // CHECK: 'dip.dilation_2d' op input, kernel, output and constant must have the same element type

  dip.dilation_2d <CONSTANT_PADDING> %input_f128, %identity_f128, %output_f128dilation, %kernelAnchorX, %kernelAnchorY, %iterations, %c_f128 : memref<3x3xf128>, memref<3x3xf128>, memref<3x3xf128>, index, index,index, f128
  // CHECK: 'dip.dilation_2d' op supports only f32, f64 and integer types. 'f128'is passed

 dip.opening_2d <CONSTANT_PADDING> %input_i32, %identity_f32, %output_f32opening, %output_f32opening1, %kernelAnchorX, %kernelAnchorY, %iterations, %c_f32 : memref<3x3xi32>, memref<3x3xf32>, memref<3x3xf32>, memref<3x3xf32>, index, index, index, f32
  // CHECK: 'dip.opening_2d' op input, kernel, output and constant must have the same element type

  dip.opening_2d <CONSTANT_PADDING> %input_f32, %identity_i32, %output_f32opening, %output_f32opening1, %kernelAnchorX, %kernelAnchorY, %iterations, %c_f32 : memref<3x3xf32>, memref<3x3xi32>, memref<3x3xf32>, memref<3x3xf32>, index, index, index, f32
  // CHECK: 'dip.opening_2d' op input, kernel, output and constant must have the same element type

  dip.opening_2d <CONSTANT_PADDING> %input_f32, %identity_f32, %output_i32opening, %output_i32opening1, %kernelAnchorX, %kernelAnchorY, %iterations, %c_f32 : memref<3x3xf32>, memref<3x3xf32>, memref<3x3xi32>, memref<3x3xi32>, index, index,index, f32
  // CHECK: 'dip.opening_2d' op input, kernel, output and constant must have the same element type

  dip.opening_2d <CONSTANT_PADDING> %input_f32, %identity_f32, %output_f32opening, %output_f32opening1, %kernelAnchorX, %kernelAnchorY, %iterations, %c_i32 : memref<3x3xf32>, memref<3x3xf32>, memref<3x3xf32>, memref<3x3xf32>, index, index,index, i32
  // CHECK: 'dip.opening_2d' op input, kernel, output and constant must have the same element type

  dip.opening_2d <CONSTANT_PADDING> %input_f128, %identity_f128, %output_f128opening, %output_f128opening1, %kernelAnchorX, %kernelAnchorY, %iterations, %c_f128 : memref<3x3xf128>, memref<3x3xf128>, memref<3x3xf128>, memref<3x3xf128>, index, index,index, f128
  // CHECK: 'dip.opening_2d' op supports only f32, f64 and integer types. 'f128'is passed

  dip.closing_2d <CONSTANT_PADDING> %input_i32, %identity_f32, %output_f32closing, %output_f32closing1, %kernelAnchorX, %kernelAnchorY, %iterations, %c_f32 : memref<3x3xi32>, memref<3x3xf32>, memref<3x3xf32>, memref<3x3xf32>, index, index, index, f32
  // CHECK: 'dip.closing_2d' op input, kernel, output and constant must have the same element type

  dip.closing_2d <CONSTANT_PADDING> %input_f32, %identity_i32, %output_f32closing, %output_f32closing1, %kernelAnchorX, %kernelAnchorY, %iterations, %c_f32 : memref<3x3xf32>, memref<3x3xi32>, memref<3x3xf32>, memref<3x3xf32>, index, index, index, f32
  // CHECK: 'dip.closing_2d' op input, kernel, output and constant must have the same element type

  dip.closing_2d <CONSTANT_PADDING> %input_f32, %identity_f32, %output_i32closing, %output_i32closing1, %kernelAnchorX, %kernelAnchorY, %iterations, %c_f32 : memref<3x3xf32>, memref<3x3xf32>, memref<3x3xi32>, memref<3x3xi32>, index, index,index, f32
  // CHECK: 'dip.closing_2d' op input, kernel, output and constant must have the same element type

  dip.closing_2d <CONSTANT_PADDING> %input_f32, %identity_f32, %output_f32closing, %output_f32closing1, %kernelAnchorX, %kernelAnchorY, %iterations, %c_i32 : memref<3x3xf32>, memref<3x3xf32>, memref<3x3xf32>, memref<3x3xf32>, index, index,index, i32
  // CHECK: 'dip.closing_2d' op input, kernel, output and constant must have the same element type

  dip.closing_2d <CONSTANT_PADDING> %input_f128, %identity_f128, %output_f128closing, %output_f128closing1, %kernelAnchorX, %kernelAnchorY, %iterations, %c_f128 : memref<3x3xf128>, memref<3x3xf128>, memref<3x3xf128>, memref<3x3xf128>, index, index,index, f128
