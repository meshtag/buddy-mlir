...
func.func @main() -> i32 {
  ...
  dip.dilation_2d <CONSTANT_PADDING> %input, %identity, %outputdilation, %kernelAnchorX, %kernelAnchorY, %iterations, %c : memref<3x3xf64>, memref<3x3xf64>, memref<3x3xf64>, index, index, index, f64
  dip.opening_2d <REPLICATE_PADDING> %input, %identity, %outputopening, %outputopening1, %kernelAnchorX, %kernelAnchorY, %iterations, %c : memref<3x3xf64>, memref<3x3xf64>, memref<3x3xf64>, memref<3x3xf64>, index, index, index, f64
  dip.closing_2d <CONSTANT_PADDING> %input, %identity, %outputclosing, %outputclosing1, %kernelAnchorX, %kernelAnchorY, %iterations, %c : memref<3x3xf64>, memref<3x3xf64>, memref<3x3xf64>, memref<3x3xf64>, index, index, index, f64
  dip.tophat_2d <REPLICATE_PADDING> %input, %identity, %outputtophat, %outputtophat1,%outputtophat2, %inputtophat1, %kernelAnchorX, %kernelAnchorY, %iterations, %c : memref<3x3xf64>, memref<3x3xf64>, memref<3x3xf64>,memref<3x3xf64>,memref<3x3xf64>,memref<3x3xf64>, index, index, index, f64
  dip.bottomhat_2d <CONSTANT_PADDING> %input, %identity, %outputbottomhat, %outputbottomhat1,%outputbottomhat2, %inputbottomhat1, %kernelAnchorX, %kernelAnchorY, %iterations, %c : memref<3x3xf64>, memref<3x3xf64>, memref<3x3xf64>,memref<3x3xf64>,memref<3x3xf64>,memref<3x3xf64>, index, index, index, f64  
