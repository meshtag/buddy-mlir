...
public:
  ...
  matchAndRewrite(Operation *op, ArrayRef<Value> operands,
    ...
    // Value CenterXValue = rewriter.create<ConstantIndexOp>(loc, centerX);
    bool check = 1;
    Value centerYValue = rewriter.create<ConstantIndexOp>(loc, centerY);
    // bool upperExtrapolate = 1, middleExtrapolate = 1, lowerExtrapolate = 1;
