...
{
  dip.morphgrad_2d <CONSTANT_PADDING> %inputImage, %kernel, %outputImage, %outputImage1,%outputImage2,  %inputImage1, %centerX, %centerY, %iterations, %constantValue, %copymemref, %copymemref1 : memref<?x?xf32>, memref<?x?xf32>, memref<?x?xf32>, memref<?x?xf32>,memref<?x?xf32>,memref<?x?xf32>, index, index,index, f32, memref<?x?xf32>, memref<?x?xf32>
  return
}

func.func @morphgrad_2d_replicate_padding(%inputImage : memref<?x?xf32>, %kernel : memref<?x?xf32>, %outputImage : memref<?x?xf32>, %outputImage1 : memref<?x?xf32>,%outputImage2 : memref<?x?xf32>, %inputImage1 : memref<?x?xf32>, %centerX : index, %centerY : index, %iterations : index, %constantValue : f32, %copymemref : memref<?x?xf32>, %copymemref1 : memref<?x?xf32>)
{
  dip.morphgrad_2d <REPLICATE_PADDING> %inputImage, %kernel, %outputImage, %outputImage1,%outputImage2, %inputImage1, %centerX, %centerY, %iterations, %constantValue, %copymemref, %copymemref1 : memref<?x?xf32>, memref<?x?xf32>, memref<?x?xf32>,memref<?x?xf32>,memref<?x?xf32>,memref<?x?xf32>, index, index, index, f32, memref<?x?xf32>, memref<?x?xf32>
  return 
}
