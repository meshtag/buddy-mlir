...
func.func @tensor_resize_2d_nearest_neighbour_interpolation(%inputImage : tensor<?x?xf32>, %horizontal_scaling_factor : f32, %vertical_scaling_factor : f32, %outputImage : tensor<?x?xf32>) attributes{llvm.emit_c_interface}
{
  return
}
